          ...
          <div class="py-1">
            <div class="row align-items-center">
              <div class="col-2">
                ...
                <a href="index.html"><img class="mb-0 site-logo" src="/website/images/logo.jpg" alt="" /></a>
              </div>
                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      <li><a href="{{route('partners')}}">همکاران / شرکا</a></li>
        ...
        <div class="row pt-12 mt-12 text-center" style="background-color: orange">
          <div class="col-md-12">
            <p style="color: black; padding-top: 15px">
              کلیه حقوق مادی و معنوی این ویب مربوط شرکت اکس میشود
            </p>
          </div>
        </div>
