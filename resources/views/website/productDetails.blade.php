...
<div class="unit-5 overlay" style="background-image: url('/website/images/asdfasd.jpg');">
    <div class="container text-center">
      <h2 class="mb-0">جزئیات محصول</h2>
      <p class="mb-0 unit-6"><a href="index.html">خانه</a> <span class="sep">></span> <span>جزئیات محصول</span></p>
    </div>
  </div>
      ...
      <div  style=" text-align: right">
        ...
        <div class="row align-items-start job-item border-bottom pb-3 mb-3 pt-3">
          ...
          <div class="col-md-3 text-left">
            <h3><?php echo $product[0]->email; ?></h3>
