              ...
              <div class="ftco-search" dir="rtl">
                <div class="row">
                  ...
                  <div class="col-md-12 tab-wrap">
                    ...
                    <div class="tab-content p-4" id="v-pills-tabContent" style="height: 400px; border: 2px solid #5cf513">
                        ...
                        <form method="POST" action="{{ route('searchOrder') }}" class="search-job">
                            ...
                            <div class="col-md-8">
                              <div class="form-group">
                                <div class="form-field">
                                  <center><h5>لطفا کد سفارش کالای خویش را در زیر وارد کنید.</h5><center> <br></br>
                                  <input type="text" name="q" class="form-control" placeholder="XXXXXXXXXXXXX کد سفارش کالای خود را وارد کنید." style="height: 50px">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                                <div class="form-field">
                                  <button type="submit" name="submit" class="btn btn-success btn-block waves-effect waves-light" style="height: 50px">
                        ...
                        <form method="POST" action="{{ route('searchProduct') }}" class="search-job">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-8">
                              <div class="form-group">
                                <div class="form-field">
                                  <center><h5>لطفا کد محصول را در زیر وارد نماید تا از اصالت محصول اطمینان حاصل کنید.</h5><center><br>
                                  <input type="text" name="q" class="form-control" placeholder="XXXXXXXXXXXXX" style="height: 50px">
                                </div>
                              </div>
                            </div>
                          </div>
